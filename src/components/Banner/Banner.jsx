        ...
        <section className="banner-area pt-20 bg-[#f5f5f5]">
            <div className="max-w-[992px] mx-auto">
                <div className="banner-inner text-center">
                    <h2 className="text-4xl md:text-7xl leading-12 md:leading-[84px] text-[#001931] font-bold">We Build</h2>
                    <h2 className="text-4xl md:text-7xl leading-12 md:leading-[84px] text-[#001931] font-bold"><span>Productive Apps</span></h2>
